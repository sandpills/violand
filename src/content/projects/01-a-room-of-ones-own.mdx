...
<Row cols="2fr 2fr" align="start">
    <Caption text="Trailer for UTR 2025">
        <Vimeo id="1153696700" vertical />
    </Caption>

    <div>
      This project is co-produced by Onassis ONX, with additional sound design by Brad Davis.

      Performed at:
        - [Under the Radar Festival 2025](https://utrfest.org/program/a-room-of-ones-own/)
        - [Onassis ONX Summer Showcase 2024](https://www.onassis.org/open-calls/onassis-onx-presents-seven-artworks-at-its-summer-showcase-in-new-york)

      Tools:
        - Custom system built in TouchDesigner
        - Azure Kinect
        - DMX Lights
        - Live audio via Ableton Live
    </div>
</Row>
